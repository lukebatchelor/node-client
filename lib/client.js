  ...
  element: function(options) {
    return this.withAuthorization().then(function(client) {
      return client.request({
        ...
        console.log('We are getting strange 404 errors when publishing, this hack exists so that we can still see the deployment url')
        console.log('Deployment url: ', response.data.published_deploy.deploy_ssl_url);
